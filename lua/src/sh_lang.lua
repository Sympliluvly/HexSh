...
function HexSh:L(srcname, phrase)
    if (HexSh.Lang[srcname][ HexSh.Config.Language ][ phrase] == nil) then return tostring(HexSh.Lang[srcname][ "ENG" ][ phrase]) end;
    return tostring( HexSh.Lang[srcname][ HexSh.Config.Language ][ phrase] );
end;
